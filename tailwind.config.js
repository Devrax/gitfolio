...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      black: extendedColors.black,
      white: extendedColors.white,
      gray: extendedColors.coolGray,
      ...
      pacific: extendedColors.pacific,
      steel: extendedColors.steel,
      orange: extendedColors.orange,
      tomato: extendedColors.tomato
    },
    spacing: {
      px: '1px',
      0: '0px',
  ...
  plugins: [
    require('tailwindcss-scroll-snap'), // For scroll snapping
    require('tailwindcss-textshadow') // For text Shadow
  ],
}
